        ...
        return (
          ...
          >
            ...
            <button
              ...
              className="w-full grid grid-cols-[1fr_100px_1fr] gap-3 px-3 py-2.5 text-left hover:bg-slate-900/40 transition-colors"
            >
              ...
              <div className="flex items-center justify-center">
                <span className={`text-[10px] font-bold px-2 py-0.5 rounded border ${confidenceColor(row.confidence)}`}>
                  {row.confidence}
                </span>
              </div>
              ...
              <div className="flex items-center flex-wrap gap-1 min-w-0 overflow-hidden">
                ...
                {row.matched_keywords.length > 4 && (
                  <span className="text-[9px] text-slate-500">+{row.matched_keywords.length - 4}</span>
                )}
              </div>
            </button>
